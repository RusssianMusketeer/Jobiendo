...
const CompanyDetail = () => {
    ...
    return (
        ...
        <div className="job-container" style={{marginTop: index===0 ? '3rem' : '2rem', width: "97.4%",cursor:"default"}}>
           
            <div className="upper-part-listing">
        <div className="title-image">
        <img className="image-logo" alt="company" loading="lazy" src={location.state.company_logo}></img>
        <div>
